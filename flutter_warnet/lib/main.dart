...
class _EntryPageState extends State<EntryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Form Pembayaran Warnet"),
      ),
      body: Padding(
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Jam_Masuk (HH:MM)'),
                validator: (value) {
                  if (value!.isEmpty) {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Jam_Keluar (HH:MM)'),
                validator: (value) {
                  if (value!.isEmpty) {
